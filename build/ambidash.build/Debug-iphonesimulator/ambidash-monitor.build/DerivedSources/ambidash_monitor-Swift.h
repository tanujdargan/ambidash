...
#ifndef AMBIDASH_MONITOR_SWIFT_H
#define AMBIDASH_MONITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ambidash_monitor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_RESILIENT_CLASS("_TtC16ambidash_monitor29AmbidashDeviceActivityMonitor")
@interface AmbidashDeviceActivityMonitor : DeviceActivityMonitor
